    ...
    [
      {
        ...
        "confidence": 0.95,
        "citations": "ivegamsft/basecoat — PRs #312, #313, #314",
        "category": "convention",
...
*Generated by [BaseCoat memory-contribute.yml](https://github.com/ivegamsft/basecoat/actions/workflows/memory-contribute.yml)*
"@
