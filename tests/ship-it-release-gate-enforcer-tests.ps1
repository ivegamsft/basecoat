...
Invoke-Scenario -Name "pilot-wawkr-canary-requires-security-and-e2e" -Params @{
  RiskBand = "medium"
  PromotionStage = "canary"
  ChangeType = "code"
  ExecutionLane = "pilot-wawkr"
  PreviousStageStatus = "pass"
  LintStatus = "pass"
  BuildStatus = "pass"
  TypeStatus = "pass"
...
Invoke-Scenario -Name "pilot-wawkr-canary-full-gate-pass" -Params @{
  RiskBand = "medium"
  PromotionStage = "canary"
  ChangeType = "code"
  ExecutionLane = "pilot-wawkr"
  ...
  RollbackRunbookRef = ""
  RollbackValidationStatus = "missing"
  GoalIds = "WAWKR-1,WAWKR-2"
  SpecGoalIds = "WAWKR-1,WAWKR-2"
  SpecStatus = "present"
  DocsStatus = "present"
  TestsStatus = "present"
  RunbookStatus = "present"
  ReleaseNotesStatus = "present"
  DocsGoalIds = "WAWKR-1,WAWKR-2"
  TestsGoalIds = "WAWKR-1,WAWKR-2"
  RunbookGoalIds = "WAWKR-1,WAWKR-2"
  ReleaseNotesGoalIds = "WAWKR-1,WAWKR-2"
} -ExpectedAllowed $true

Invoke-Scenario -Name "pilot-wawkr-canary-missing-artifacts-blocks" -Params @{
  RiskBand = "medium"
  PromotionStage = "canary"
  ChangeType = "code"
  ExecutionLane = "pilot-wawkr"
...
Invoke-Scenario -Name "pilot-work-tracker-lane-requires-security-and-e2e" -Params @{
  RiskBand = "medium"
  PromotionStage = "validate"
  ChangeType = "code"
  ExecutionLane = "pilot-work-tracker"
  PreviousStageStatus = "pass"
  LintStatus = "pass"
  BuildStatus = "pass"
  TypeStatus = "pass"
  ...
  RollbackValidationStatus = "missing"
  GoalIds = "WT-1,WT-2"
  SpecGoalIds = "WT-1,WT-2"
  SpecStatus = "present"
  DocsStatus = "present"
  TestsStatus = "present"
  RunbookStatus = "present"
  ReleaseNotesStatus = "present"
  DocsGoalIds = "WT-1,WT-2"
  TestsGoalIds = "WT-1,WT-2"
  RunbookGoalIds = "WT-1,WT-2"
  ReleaseNotesGoalIds = "WT-1,WT-2"
} -ExpectedAllowed $false -ExpectedBlockerContains "required-gates-failed:e2e,security"

Invoke-Scenario -Name "pilot-work-tracker-lane-full-gate-pass" -Params @{
  RiskBand = "medium"
  PromotionStage = "validate"
  ChangeType = "code"
  ExecutionLane = "pilot-work-tracker"
  ...
  RollbackRunbookRef = ""
  RollbackValidationStatus = "missing"
  GoalIds = "WT-1,WT-2,WT-3"
  SpecGoalIds = "WT-1,WT-2,WT-3"
  SpecStatus = "present"
  DocsStatus = "present"
  TestsStatus = "present"
  RunbookStatus = "present"
  ReleaseNotesStatus = "present"
  DocsGoalIds = "WT-1,WT-2,WT-3"
  TestsGoalIds = "WT-1,WT-2,WT-3"
  RunbookGoalIds = "WT-1,WT-2,WT-3"
  ReleaseNotesGoalIds = "WT-1,WT-2,WT-3"
} -ExpectedAllowed $true

Invoke-Scenario -Name "pilot-work-tracker-lane-missing-artifacts-blocks" -Params @{
  RiskBand = "medium"
  PromotionStage = "validate"
  ChangeType = "code"
  ExecutionLane = "pilot-work-tracker"
