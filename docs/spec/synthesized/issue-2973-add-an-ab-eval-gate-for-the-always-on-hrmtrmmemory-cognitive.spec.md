...
# Spec: Add an A/B eval gate for the always-on HRM/TRM/memory cognitive layer (or demote it)
...
- PRD: `docs/prd/synthesized/issue-2973-add-an-ab-eval-gate-for-the-always-on-hrmtrmmemory-cognitive.prd.md`
- Refs #2973
