...
# Spec: ship-it: release 2 overlay ownership and deploy auth hardening
...
- PRD: `docs/prd/synthesized/issue-3438-ship-it-release-2-overlay-ownership-and-deploy-auth-hardenin.prd.md`
- Refs #3438
