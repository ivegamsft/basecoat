...
# Spec: Enforce repo-owned vs factory-owned workflow boundary + guard against retirement outages
...
- PRD: `docs/prd/synthesized/issue-2979-enforce-repo-owned-vs-factory-owned-workflow-boundary-guard-.prd.md`
- Refs #2979
