...
[`instructions/basecoat-60-workflow-multi-repo-orchestration.instructions.md`](https://github.com/ivegamsft/basecoat/blob/main/instructions/basecoat-60-workflow-multi-repo-orchestration.instructions.md).
...
- Related instruction: [`instructions/basecoat-60-workflow-ci-firewall.instructions.md`](https://github.com/ivegamsft/basecoat/blob/main/instructions/basecoat-60-workflow-ci-firewall.instructions.md)
- Related instruction: [`instructions/basecoat-50-security-secrets-management.instructions.md`](https://github.com/ivegamsft/basecoat/blob/main/instructions/basecoat-50-security-secrets-management.instructions.md)
