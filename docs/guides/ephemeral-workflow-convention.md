...
- [`instructions/basecoat-60-workflow-workflow-integrity.instructions.md`](https://github.com/ivegamsft/basecoat/blob/main/instructions/basecoat-60-workflow-workflow-integrity.instructions.md) — workflow integrity rules
