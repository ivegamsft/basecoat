...
|---|---|---|
| **Agents** | 118 | End-to-end task executors — sprint planners, code reviewers, security analysts, and more |
| **Skills** | 117 | Reusable domain capabilities invoked by agents |
