...
|---|---|---|
| **Agents** | 123 | End-to-end task executors — sprint planners, code reviewers, security analysts, and more |
| **Skills** | 123 | Reusable domain capabilities invoked by agents |
