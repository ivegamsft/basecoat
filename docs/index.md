...
|---|---|---|
| **Agents** | 129 | End-to-end task executors — sprint planners, code reviewers, security analysts, and more |
| **Skills** | 132 | Reusable domain capabilities invoked by agents |
