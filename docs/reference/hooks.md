...
> **Tracking:** Issue [#145](internal source issue)
...
See issue [#1172](internal source issue) for the full design and implementation plan.
...
- Issue [#145](internal source issue) — Tracking issue for lifecycle hook specification
