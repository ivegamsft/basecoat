...
**Issue:** [#2051](internal source issue)  
**Parent Epic:** [#1452](internal source issue)  
**Owner:** @ibuyspy  
...
- Configure weekly scorecard workflow ([#2050](internal source issue))
...
3. Posts readout comment to [#2050](internal source issue)
...
Weekly readout target: [Issue #2050](internal source issue)
