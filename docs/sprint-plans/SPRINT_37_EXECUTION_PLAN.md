...
### Feature #1737: Testing & Quality Assurance (Wave 1-3) ⚠️ CRITICAL PATH
...
Wave 1 (Days 1-3):
  🔴 #1732 — Design: Project model (CRITICAL BLOCKER)
    ...
    Status: Todo → In Progress
    ⚠️ GATE: This blocks all Wave 2-3 design work
...
Target: All merged by EOD 2026-07-21 (sprint end)
```
