...
### Sprint 1 — Architecture Baseline ([PR #1955](https://github.com/IBuySpy-Shared/basecoat/pull/1955))
...
### Sprint 2 — Intent Contract + Goal-Loop Engine ([PR #1958](https://github.com/IBuySpy-Shared/basecoat/pull/1958))
